function PlotRegret4(regret1,regret2,regret3,regret4,std1,std2,std3,std4,CI95_1,CI95_2,CI95_3,CI95_4,Alg1,Alg2,Alg3,Alg4)
T = size(regret1,2);
...
patch('XData',[1:T fliplr(1:T)],'YData',[CI95_3(1,:) fliplr(CI95_3(2,:))], 'facecolor','red',...
        'edgecolor','none', ...
        'facealpha', 0.3)
plot(mean(regret4,1), 'color',[0.4660 0.6740 0.1880], 'LineStyle', ':', 'LineWidth',2);
